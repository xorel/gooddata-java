...
class PopMeasureDefinitionTest extends Specification {
    ...
    def "should serialize"() {
        ...
        that new PopMeasureDefinition('mId', new ObjUriQualifier('/gdc/md/projectId/obj/1')),
                jsonEquals(resource('transform/popMeasureDefinition.json'))
    }

    def "should deserialize"() {
        when:
        PopMeasureDefinition measure = readObjectFromResource('/transform/popMeasureDefinition.json', PopMeasureDefinition)
