...
class DimensionTest extends Specification {
    ...
    def "should serialize"() {
        ...
        that new Dimension("dId", "i1", "i2"),
                jsonEquals(resource('transform/dimension.json'))
    }
    ...
    def "should serialize full"() {
        ...
        that new Dimension("dId", "i1", "i2")
                .addTotal(TOTAL),
                    jsonEquals(resource('transform/dimensionFull.json'))
    }

    def "should deserialize"() {
        when:
        Dimension dimension = readObjectFromResource('/transform/dimension.json', Dimension)
    ...
    def "should deserialize full"() {
        when:
        Dimension dimension = readObjectFromResource('/transform/dimensionFull.json', Dimension)
