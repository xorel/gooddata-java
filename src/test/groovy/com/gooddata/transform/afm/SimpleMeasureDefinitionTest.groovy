...
class SimpleMeasureDefinitionTest extends Specification {
    ...
    def "should serialize full"() {
        ...
        that new SimpleMeasureDefinition(QUALIFIER, Aggregation.AVG,
                ...
                jsonEquals(resource('transform/afm/simpleMeasureDefinitionFull.json'))
    }

    def "should serialize"() {
        expect:
        that new SimpleMeasureDefinition(QUALIFIER),
                jsonEquals(resource('transform/afm/simpleMeasureDefinition.json'))
    }

    def "should deserialize"() {
        when:
        SimpleMeasureDefinition definition = readObjectFromResource('/transform/afm/simpleMeasureDefinition.json', SimpleMeasureDefinition)
    ...
    def "should deserialize full"() {
        when:
        SimpleMeasureDefinition definition = readObjectFromResource('/transform/afm/simpleMeasureDefinitionFull.json', SimpleMeasureDefinition)
